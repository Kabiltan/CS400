...
public class RedBlackTreeUI {
   ...
   * If a song with the respective rank
   * already exists, this method will
   * not add the new song.
   * 
  ...
  private static void createSong(String song, int rank) {
    ...
    songDataBase.insert(rank, song); // Add the song and ranking to the Song Database
      ...
      System.out.println("Sorry a song with that rank already exists in the database. Please try again with a different rank");
      return;
    }
  ...
  public static void listCommands() {
    ...
    System.out.println("getSize - Displays the total number of songs within the database");
